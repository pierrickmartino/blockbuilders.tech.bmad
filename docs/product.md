...
| **Remove Sentiment Analysis from Backtest Results** | ✅ Complete | Remove sentiment analysis cards, summaries, and backtest-specific sentiment dependencies from authenticated and shared results views; keep Market Overview sentiment unchanged and avoid empty placeholders |
